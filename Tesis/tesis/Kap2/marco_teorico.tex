...
\subsection{Cuantización del modo fonónico}
...
\section{Molécula excitónica con acoplamiento de Förster}
\label{sec:molecula_excitonica}

\subsection{Hamiltoniano del sistema de dos puntos cuánticos}
\label{sec:hamiltoniano_2qd}

\subsection{Estados colectivos brillante y oscuro}
\label{sec:estados_colectivos}

\subsection{Hamiltoniano efectivo en el subespacio brillante}
\label{sec:hamiltoniano_efectivo}
...
\subsection{Ecuación maestra de Born--Markov}
