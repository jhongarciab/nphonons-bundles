# -*- coding: utf-8 -*-
"""Tarea 45(d): variantes de la Tarea 42. Uso: tarea45d_worker.py <w> <gx> <gz/kappa> <N> <variante> <outfile>
variantes: full | nocounter (sin terminos de 3w) | nogz_pair (sin gz sz a, con intercambio de pares explicito G) | nocounter_nogz_pair"""
...
k2 = p['kappa2']
print(f"OK {var} w={w} gx={gx} gz/k={gzk} N={N} k2/k={k2/kappa:.3g} Pcmax={res['Pc'].max():.4f} rate_fit={rate_fit:.3e} (pred {rate_pred:.3e}, espectral {rate_spec:.3e}) "
