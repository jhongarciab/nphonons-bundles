...
plt.savefig("results/oficial/purity_2qd_heatmap_paper.pdf", bbox_inches='tight')
plt.savefig("results/oficial/pgf/purity_2qd_heatmap_paper.pgf")
...
plt.savefig("results/oficial/purity_2qd_cuts_paper.pdf", bbox_inches='tight')
plt.savefig("results/oficial/pgf/purity_2qd_cuts_paper.pgf")
