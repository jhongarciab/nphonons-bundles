...
if not RERUN:
    ...
    np.savez(
        RESULTS_DATA_DIR / "rabi_allreg_data.npz",
    ...
    data = np.load(RESULTS_DATA_DIR / "rabi_allreg_data.npz")
...
plt.savefig(RESULTS_OFICIAL_DIR / "rabi_allreg.pdf", bbox_inches="tight")
plt.savefig(RESULTS_PGF_DIR / "rabi_allreg.pgf")
plt.close()
