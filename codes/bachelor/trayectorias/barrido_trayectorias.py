...
# EXPORTAR
# =============================================================================
np.savez(RESULTS_DATA_DIR / 'trayectorias_2qd_gallery.npz',
...
fig.suptitle(rf'Galería de trayectorias 2QD — top {n_show} de {ntraj} '
             ...
             fontsize=11, y=1.002)
plt.tight_layout()
plt.savefig(RESULTS_OFICIAL_DIR / 'trayectorias_2qd_gallery.pdf', bbox_inches='tight')
plt.savefig(RESULTS_OFICIAL_DIR / 'trayectorias_2qd_gallery.png', dpi=150, bbox_inches='tight')
