...
if not RERUN:
    ...
    np.savez(RESULTS_DATA_DIR / 'fig_S6_data.npz',
             gamma_arr=gamma_arr,
    ...
    data = np.load(RESULTS_DATA_DIR / 'fig_S6_data.npz')
...
plt.savefig(RESULTS_OFICIAL_DIR / "fig_S6_scaffold.pdf", bbox_inches='tight')
plt.savefig(RESULTS_PGF_DIR / "fig_S6_scaffold.pgf")
