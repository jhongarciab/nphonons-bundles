...
if not RERUN:
    ...
    # Guardar datos
    np.savez(RESULTS_DATA_DIR / 'g2_decay_2qds_data.npz',
             gamma_arr=gamma_arr,
             Delta_2ph=Delta_2ph,
             J=J,
    ...
    data = np.load(RESULTS_DATA_DIR / 'g2_decay_2qds_data.npz')
...
plt.savefig(RESULTS_OFICIAL_DIR / "g2_decay_2qds.pdf", bbox_inches='tight')
plt.savefig(RESULTS_PGF_DIR / "g2_decay_2qds.pgf")
print("✓ Figura guardada: results/oficial/g2_decay_2qds.pdf")
plt.close()
