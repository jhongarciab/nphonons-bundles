...
if not RERUN:
    ...
    np.savez(
        RESULTS_DATA_DIR / "g_n_orders_stacked_data.npz",
...
#plt.show()
plt.savefig(RESULTS_OFICIAL_DIR / "g_n_orders_stacked.pdf", bbox_inches="tight")
plt.savefig(RESULTS_PGF_DIR / "g_n_orders_stacked.pgf")
plt.close()
