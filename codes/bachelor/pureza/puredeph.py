...
RESULTS_DIR = Path(__file__).resolve().parents[2] / "results" / "oficial"
...
plt.tight_layout()
plt.savefig(RESULTS_DIR / "fig_S5_replica.pdf", bbox_inches='tight')
plt.savefig(RESULTS_DIR / "fig_S5_replica.png", dpi=200, bbox_inches='tight')
