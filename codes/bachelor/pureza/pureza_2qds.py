...
plt.savefig(RESULTS_OFICIAL_DIR / "purity_2qd_heatmap.pdf", bbox_inches='tight')
plt.savefig(RESULTS_PGF_DIR / "purity_2qd_heatmap.pgf")
...
plt.savefig(RESULTS_OFICIAL_DIR / "purity_2qd_cuts.pdf", bbox_inches='tight')
plt.savefig(RESULTS_PGF_DIR / "purity_2qd_cuts.pgf")
