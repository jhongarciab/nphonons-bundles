...
# EXPORTAR DATOS
# =============================================================================
np.savez(RESULTS_DATA_DIR / 'concurrence_2qd_data.npz',
...
plt.tight_layout()
plt.savefig(RESULTS_OFICIAL_DIR / "concurrence_2qd.pdf", bbox_inches='tight')
plt.savefig(RESULTS_OFICIAL_DIR / "concurrence_2qd.png", dpi=200, bbox_inches='tight')
