...
plt.tight_layout()
plt.savefig(RESULTS_OFICIAL_DIR / "dark_state_population.pdf", bbox_inches='tight')
plt.savefig(RESULTS_OFICIAL_DIR / "dark_state_population.png", dpi=200, bbox_inches='tight')
