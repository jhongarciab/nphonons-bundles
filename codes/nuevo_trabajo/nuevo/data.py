...
# CARGAR DATOS
# =============================================================================
data = np.load(RESULTS_DATA_DIR / 'sweet_spot_data.npz')
...
plt.tight_layout()
plt.savefig(RESULTS_OFICIAL_DIR / "sweet_spot_final.pdf", bbox_inches='tight')
plt.savefig(RESULTS_OFICIAL_DIR / "sweet_spot_final.png", dpi=200, bbox_inches='tight')
