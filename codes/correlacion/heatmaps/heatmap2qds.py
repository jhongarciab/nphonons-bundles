...
if not RERUN:
    ...
    np.savez(
        "results/data/corr_2qds_combined_heatmap_data.npz",
        Delta_arr=Delta_arr,
    ...
    data = np.load("results/data/corr_2qds_combined_heatmap_data.npz")
...
# SALIDA
# -----------------------------------------------------------------------------
plt.savefig("results/oficial/corr_2qds_combined_heatmap.pdf", bbox_inches="tight")
plt.savefig("results/oficial/pgf/corr_2qds_combined_heatmap.pgf")
plt.close()
