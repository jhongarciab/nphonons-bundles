...
if not RERUN:
    ...
    np.savez(
        "results/data/g_n_orders_stacked_paper_data.npz",
...
#plt.show()
plt.savefig("results/oficial/g_n_orders_stacked_paper.pdf", bbox_inches="tight")
plt.savefig("results/oficial/pgf/g_n_orders_stacked_paper.pgf")
plt.close()
